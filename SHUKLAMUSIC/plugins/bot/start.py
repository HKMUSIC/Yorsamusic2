...
async def start_pm(client, message: Message, _):
    ...
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>ɢᴏᴊᴏ</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>ɢᴏᴊᴏ ꭙ</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>ɢᴏᴊᴏ ꭙ ϻᴜsɪᴄ ♪</b>")
    await asyncio.sleep(0.1)
    await loading_1.edit_text("<b>ɢᴏᴊᴏ ꭙ ϻᴜsɪᴄ♪\nsᴛᴧʀᴛєᴅ!🥀</b>")
    await asyncio.sleep(0.1)
